  ...
  $.ajax({
    ...
    success: function (res) {
      if (res.status == "ok") {
        ...
        $('#new_proveedor').html('');
        $('#new_unidad_negocio').html('');
        $('#new_sociedad').html('');
        $('#new_pais').html('');
        $('#new_cliente').html('');
        $('#new_contacto').html('');
        $('#new_tipo_contrato').html('');
        $('#new_region').html('');
        ...
        $('#new_tipo_contrato').html(select_options_tipo);
        $('#new_region').html(select_options_region);
        $('#new_fecha_fin').val(conv_date(res.contract.FECHA_FIN));
        $('#new_fecha_inicio').val(conv_date(res.contract.FECHA_INICIO));
        $('#new_fecha_firma').val(conv_date(res.contract.FECHA_FIRMA));
        $('#new_comentario').val(res.contract.COMENTARIO);
        $('#new_up_id').val(id)
        $('#Add_Modal').modal('show');
      } else {
        console.log(res);
